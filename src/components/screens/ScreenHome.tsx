        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="p-5 sm:p-6 rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] flex flex-col justify-between">
              ...
              <div>
                <h3 className="text-base font-bold text-[#111827] mb-1.5 sm:mb-2">Professional Editorial Layouts</h3>
            ...
            <div className="p-5 sm:p-6 rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] flex flex-col justify-between">
              ...
              <div>
                <h3 className="text-base font-bold text-[#111827] mb-1.5 sm:mb-2">Real-time Scanner & Analysis</h3>
                <p className="text-sm text-[#6B7280] leading-relaxed">
            ...
            <div className="p-5 sm:p-6 rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] flex flex-col justify-between">
              ...
              <div>
                <h3 className="text-base font-bold text-[#111827] mb-1.5 sm:mb-2">High-Resolution Vector Export</h3>
                <p className="text-sm text-[#6B7280] leading-relaxed">
