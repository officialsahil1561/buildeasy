      ...
      <div className="flex flex-col gap-6">
        ...
        {displaySummary && (
          <section style={getSectionStyle('summary', data.customization)} className="space-y-2">
            <h2 className="text-[11pt] font-bold uppercase tracking-wider text-gray-900 border-b border-gray-200 pb-1">
              ...
              {experience.map((exp, idx) => (
                <div key={idx} className="space-y-1.5">
                  <div className="flex justify-between items-baseline">
                    ...
                    <span className="text-[9.5pt] text-gray-600 font-medium shrink-0">{exp.startDate} – {exp.endDate}</span>
                  </div>
              ...
              {education.map((edu, idx) => (
                <div key={idx} className="space-y-1">
                  <div className="flex justify-between items-baseline">
                    ...
                    <span className="text-[9.5pt] text-gray-600 font-medium shrink-0">{edu.startDate} – {edu.endDate}</span>
                  </div>
                ...
                <div key={idx} className="space-y-1.5">
                  <div className="flex justify-between items-baseline">
                    ...
                    <div className="flex gap-3 text-[9.5pt]">
                      {proj.link && (
                        <a href={proj.link} target="_blank" rel="noreferrer" className="text-blue-600 hover:underline font-medium">
                          Live Demo ↗
                        </a>
                      )}
                      {proj.githubUrl && (
                        <a href={proj.githubUrl} target="_blank" rel="noreferrer" className="text-blue-600 hover:underline font-medium">
                          GitHub ↗
                        </a>
                      )}
                    </div>
